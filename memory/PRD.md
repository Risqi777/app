...
Buatkan website untuk pembuatan jadwal kerja shift dengan 16 personil, 3 shift (Pagi 07-13, Siang 13-19, Malam 19-07) + Libur (2 min, 3 max per 3 hari kerja). Menu pengajuan cuti (Tahunan, Penting, Besar), sakit, dinas luar, diklat, penugasan. Login Admin & Personil dengan email + NIK + password. Daftar akun. Admin CRUD penuh, Personil view + ajukan. Sederhana, profesional. Admin dapat edit judul, tanda tangan, nama, upload gambar. Multi-platform.

## User Personas
- **Admin (Kepala Unit)**: Kelola personil, generate jadwal, approve/reject pengajuan, atur header laporan cetak.
...
- Schedule: auto-generate (3 kerja / 2 libur, rotasi Pagi→Siang→Malam), edit sel manual via dropdown per cell, view matrix bulanan.
...
- Settings: title, subtitle, logo (upload base64), signature (upload base64), signer_name/jabatan/nik, place.
